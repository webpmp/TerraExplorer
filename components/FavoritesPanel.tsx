...
const FavoritesPanel: React.FC<FavoritesPanelProps> = ({
  ...
  return (
    <>
      <div className={`absolute top-[281px] left-8 z-30 w-72 md:w-80 max-h-[calc(100vh-345px)] flex flex-col animate-in slide-in-from-left-8 fade-in duration-300 transition-opacity duration-300 ${dimmed ? 'opacity-20 pointer-events-none' : 'opacity-100'}`}>
