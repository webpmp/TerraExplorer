...
export const DETERMINISTIC_LOCATION_DB: Record<string, DeterministicLocationEntry> = {
  ...
  "hms hood": { name: "HMS Hood Wreck Site", type: LocationType.POI, entityType: "shipwreck", lat: 63.3333, lng: -31.8333, suggestedZoom: 7, description: "HMS Hood was a Royal Navy battlecruiser sunk during the Battle of the Denmark Strait on May 24, 1941. The wreckage was discovered in July 2001 in the Denmark Strait between Greenland and Iceland at a depth of 2,800 meters.", context: { region: "Denmark Strait", country: "Iceland" } },
  "the hms hood": { name: "HMS Hood Wreck Site", type: LocationType.POI, entityType: "shipwreck", lat: 63.3333, lng: -31.8333, suggestedZoom: 7, description: "HMS Hood was a Royal Navy battlecruiser sunk during the Battle of the Denmark Strait on May 24, 1941. The wreckage was discovered in July 2001 in the Denmark Strait between Greenland and Iceland at a depth of 2,800 meters.", context: { region: "Denmark Strait", country: "Iceland" } },
  "hms hood wreck site": { name: "HMS Hood Wreck Site", type: LocationType.POI, entityType: "shipwreck", lat: 63.3333, lng: -31.8333, suggestedZoom: 7, description: "HMS Hood was a Royal Navy battlecruiser sunk during the Battle of the Denmark Strait on May 24, 1941. The wreckage was discovered in July 2001 in the Denmark Strait between Greenland and Iceland at a depth of 2,800 meters.", context: { region: "Denmark Strait", country: "Iceland" } },
  "hms hood found": { name: "HMS Hood Wreck Site", type: LocationType.POI, entityType: "shipwreck", lat: 63.3333, lng: -31.8333, suggestedZoom: 7, description: "HMS Hood was a Royal Navy battlecruiser sunk during the Battle of the Denmark Strait on May 24, 1941. The wreckage was discovered in July 2001 in the Denmark Strait between Greenland and Iceland at a depth of 2,800 meters.", context: { region: "Denmark Strait", country: "Iceland" } },
  "the hms hood found": { name: "HMS Hood Wreck Site", type: LocationType.POI, entityType: "shipwreck", lat: 63.3333, lng: -31.8333, suggestedZoom: 7, description: "HMS Hood was a Royal Navy battlecruiser sunk during the Battle of the Denmark Strait on May 24, 1941. The wreckage was discovered in July 2001 in the Denmark Strait between Greenland and Iceland at a depth of 2,800 meters.", context: { region: "Denmark Strait", country: "Iceland" } },
  "hms hood shipwreck": { name: "HMS Hood Wreck Site", type: LocationType.POI, entityType: "shipwreck", lat: 63.3333, lng: -31.8333, suggestedZoom: 7, description: "HMS Hood was a Royal Navy battlecruiser sunk during the Battle of the Denmark Strait on May 24, 1941. The wreckage was discovered in July 2001 in the Denmark Strait between Greenland and Iceland at a depth of 2,800 meters.", context: { region: "Denmark Strait", country: "Iceland" } },
  "the hms hood shipwreck": { name: "HMS Hood Wreck Site", type: LocationType.POI, entityType: "shipwreck", lat: 63.3333, lng: -31.8333, suggestedZoom: 7, description: "HMS Hood was a Royal Navy battlecruiser sunk during the Battle of the Denmark Strait on May 24, 1941. The wreckage was discovered in July 2001 in the Denmark Strait between Greenland and Iceland at a depth of 2,800 meters.", context: { region: "Denmark Strait", country: "Iceland" } },
  ...
  "boston massacre": { name: "Boston Massacre Site", type: LocationType.POI, entityType: "historical_event", lat: 42.3588, lng: -71.0578, suggestedZoom: 9, description: "The Boston Massacre Site marks the location outside the Old State House on Devonshire and State Streets where British soldiers fired into a crowd of colonists on March 5, 1770.", context: { city: "Boston", state: "Massachusetts", country: "United States" } },
  ...
  "pyramids of giza": { name: "Pyramids of Giza", type: LocationType.POI, entityType: "archaeological_site", lat: 29.9792, lng: 31.1342, suggestedZoom: 10, description: "The Pyramids of Giza are an ancient Egyptian necropolis complex comprising the Great Pyramid of Khufu, the Pyramid of Khafre, and the Pyramid of Menkaure on the Giza Plateau near Cairo.", climate: { koppenCode: "BWh", description: "Hot desert climate" }, context: { city: "Giza", state: "Giza Governorate", country: "Egypt" } },
  "the pyramids of giza": { name: "Pyramids of Giza", type: LocationType.POI, entityType: "archaeological_site", lat: 29.9792, lng: 31.1342, suggestedZoom: 10, description: "The Pyramids of Giza are an ancient Egyptian necropolis complex comprising the Great Pyramid of Khufu, the Pyramid of Khafre, and the Pyramid of Menkaure on the Giza Plateau near Cairo.", climate: { koppenCode: "BWh", description: "Hot desert climate" }, context: { city: "Giza", state: "Giza Governorate", country: "Egypt" } },
  "giza pyramids": { name: "Pyramids of Giza", type: LocationType.POI, entityType: "archaeological_site", lat: 29.9792, lng: 31.1342, suggestedZoom: 10, description: "The Pyramids of Giza are an ancient Egyptian necropolis complex comprising the Great Pyramid of Khufu, the Pyramid of Khafre, and the Pyramid of Menkaure on the Giza Plateau near Cairo.", climate: { koppenCode: "BWh", description: "Hot desert climate" }, context: { city: "Giza", state: "Giza Governorate", country: "Egypt" } },
  "great pyramid of giza": { name: "Pyramids of Giza", type: LocationType.POI, entityType: "archaeological_site", lat: 29.9792, lng: 31.1342, suggestedZoom: 10, description: "The Pyramids of Giza are an ancient Egyptian necropolis complex comprising the Great Pyramid of Khufu, the Pyramid of Khafre, and the Pyramid of Menkaure on the Giza Plateau near Cairo.", climate: { koppenCode: "BWh", description: "Hot desert climate" }, context: { city: "Giza", state: "Giza Governorate", country: "Egypt" } },
  "giza pyramid complex": { name: "Pyramids of Giza", type: LocationType.POI, entityType: "archaeological_site", lat: 29.9792, lng: 31.1342, suggestedZoom: 10, description: "The Pyramids of Giza are an ancient Egyptian necropolis complex comprising the Great Pyramid of Khufu, the Pyramid of Khafre, and the Pyramid of Menkaure on the Giza Plateau near Cairo.", climate: { koppenCode: "BWh", description: "Hot desert climate" }, context: { city: "Giza", state: "Giza Governorate", country: "Egypt" } },
  "eiffel tower": { name: "Eiffel Tower", type: LocationType.POI, entityType: "landmark", lat: 48.8584, lng: 2.2945, suggestedZoom: 12, description: "The Eiffel Tower is a wrought-iron lattice tower on the Champ de Mars in Paris, France, constructed from 1887 to 1889 as the centerpiece of the 1889 World's Fair.", climate: { koppenCode: "Cfb", description: "Oceanic climate" }, context: { city: "Paris", state: "Île-de-France", country: "France" } },
  "the eiffel tower": { name: "Eiffel Tower", type: LocationType.POI, entityType: "landmark", lat: 48.8584, lng: 2.2945, suggestedZoom: 12, description: "The Eiffel Tower is a wrought-iron lattice tower on the Champ de Mars in Paris, France, constructed from 1887 to 1889 as the centerpiece of the 1889 World's Fair.", climate: { koppenCode: "Cfb", description: "Oceanic climate" }, context: { city: "Paris", state: "Île-de-France", country: "France" } },
  "mount everest": { name: "Mount Everest", type: LocationType.POI, entityType: "mountain", lat: 27.9881, lng: 86.9250, suggestedZoom: 8, description: "Mount Everest is Earth's highest mountain above sea level, located in the Mahalangur Himal sub-range of the Himalayas on the border between Nepal and China.", climate: { koppenCode: "ET", description: "Tundra climate" }, context: { country: "Nepal / China" } },
  "mt everest": { name: "Mount Everest", type: LocationType.POI, entityType: "mountain", lat: 27.9881, lng: 86.9250, suggestedZoom: 8, description: "Mount Everest is Earth's highest mountain above sea level, located in the Mahalangur Himal sub-range of the Himalayas on the border between Nepal and China.", climate: { koppenCode: "ET", description: "Tundra climate" }, context: { country: "Nepal / China" } },
  "the mount everest": { name: "Mount Everest", type: LocationType.POI, entityType: "mountain", lat: 27.9881, lng: 86.9250, suggestedZoom: 8, description: "Mount Everest is Earth's highest mountain above sea level, located in the Mahalangur Himal sub-range of the Himalayas on the border between Nepal and China.", climate: { koppenCode: "ET", description: "Tundra climate" }, context: { country: "Nepal / China" } },
