...
export const DETERMINISTIC_LOCATION_DB: Record<string, DeterministicLocationEntry> = {
  ...
  "grand canyon": { name: "Grand Canyon National Park", type: LocationType.POI, entityType: "national_park", lat: 36.0565, lng: -112.1250, suggestedZoom: 8 },
  "grand canyon national park": { name: "Grand Canyon National Park", type: LocationType.POI, entityType: "national_park", lat: 36.0565, lng: -112.1250, suggestedZoom: 8 },
  ...
  "matterhorn": { name: "Matterhorn", type: LocationType.POI, entityType: "mountain", lat: 45.9765, lng: 7.6586, suggestedZoom: 8 },
